...
const FloatingWhatsApp = () => {
  ...
  const telegramUsername = siteConfig.contact.telegram;
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      <motion.a
        ...
        className="flex h-14 w-14 items-center justify-center rounded-full bg-[#0088cc] text-white shadow-lg hover:bg-[#0077b5] transition-colors"
